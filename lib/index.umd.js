(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.jsSdk = {}));
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            codeExist = window.location.search.includes('code'); // 判断是否需要重定向
            if (unAuth && !codeExist) {
  ...
  var initSdk$1 = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config, getConfigSignature, getAgentConfigSignature) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            corpId = config.corpId, agentId = config.agentId; // 获取 wx.config - signature
            _context.next = 3;
          ...
          case 3:
            ...
            return configAndReady({
              ...
              jsApiList: wxApis$1 // 必填，需要使用的JS接口列表，凡是要调用的接口都需要传进来
            });
          case 7:
            _context.next = 9;
