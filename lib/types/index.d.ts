import { Config, GetConfigSignature, GetAgentConfigSignature, GetUserByCode, AsyncCallMap, CallMap, InvokeMap } from './types';
...
export declare const checkRedirect: (config: Config, getUserByCode: GetUserByCode) => Promise<void>;
